...
object Dependencies {
  ...
  object Libraries {
    ...
    def tsec(artifact: String): ModuleID = "io.github.jmcardon"%% artifact % Versions.tsec
    ...
    lazy val scalaTestPlus       = "org.scalatestplus"     %% "scalacheck-1-15"            % Versions.scalaTestPlus
